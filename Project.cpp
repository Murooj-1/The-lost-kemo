...
GLuint woodTexture;
char imagePath[] = "C:\\Users\\msms-\\OneDrive\\”ÿÕ «·„ﬂ »\\P.bmp";

//-----------------------------[14]---------------------------
float xpos_cloud_s14 = -0.5;
float orthoValue_s14 = 1;
float alphaValue_s14 = 0.0016;
...
void scene4() {
    ...
    if (xpos_cloud_reverse >= -2) {
        xpos_cloud_reverse -= 0.0002;
        //  std::cout << "xpos_cloud_reverse..." << xpos_cloud_reverse;
    }
    else {
        xpos_cloud_reverse = 0.0009;
    }
...
void scene14() {
    ...
    //ZOOM_IN
    gluOrtho2D(-orthoValue_s14, orthoValue_s14, -orthoValue_s14, orthoValue_s14);
...
void init()
{
    glClearColor(0.6, 0.9, 1.0, 1.0f); // Set background color to White and opaque
    ...
    glLoadIdentity();
    //------- Texture ---------
    woodTexture = LoadTexture(imagePath, 200, 200);
}
            ...
            glY >= boxY2 - boxSizey / 2 && glY <= boxY2 + boxSizey / 2)
        {
           ...
           // std::cout << "at (" << glX << ", " << glY << ")" << std::endl;
            fprintf(stderr, "\n------------------"
                ...
                "\nHE RAN FOR TOO LONG BUT HE DIDNíT REACH TO THE CORNFIELDS"
                ...
                "\nTHE RABBIT : LAST NIGHT THIS SMALL ANIMAL CAME TO US AND WE DIDNíT KNOW"
                "\nWHERE HIS HOME WAS, SO WE COULD RETURN HIM TO IT."
                "\nTHE OWL : DONíT WORRY RABBIT.I WILL LOOK FOR HIS HOME"
                ...
                "\nTHE OWL KNEW THAT THEY WERE KEMOíS FAMILY AND HE BROUGHT KEMO BACK"
                ...
                "\nDIDNíT I TELL  NOT TO BE LATE, AND COME BEFORE THE SUN SET ?\n"
...
To switch between scenes :
 we used a library : >chrono<
Reference : https://www.opengl.org/resources/libraries/glut/spec3/node64.html
We used the method : glutTimerFunc
 Reference : 7.19 glutTimerFunc (opengl.org)
 //----------------------------------------
 To write on the screen :
 We used the method : glutBitmapCharacter
 Reference : 10.1 glutBitmapCharacter (opengl.org)
 //----------------------------------------
 To handle mouse button :
  Reference:
 opengl - Using GLFW to capture mouse dragging? [C++] - Stack Overflow
 c# - How can I use screen space coordinates directly with OpenGL? - Stack Overflow
*/